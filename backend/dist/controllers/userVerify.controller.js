...
exports.userVerifyController.get("/verify/:ID/:verifyString", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.userVerifyController.post("/forgot-password", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.userVerifyController.post("/forgot-password/:ID/:forgotVerifyString", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const forgotInfo = yield forgotPassword_model_1.forgotPassword.findOne({ _id: ID });
        if (!forgotInfo)
            throw new Error("Bad Request");
        ...
        const htmlContent = yield (0, promises_1.readFile)(filePath, "utf-8");
        res.status(httpsStatusCodes_util_1.HttpStatusCodes.OK).json({ msg: "Password reset successful" });
        ;
    }
    catch (err) {
        (0, error_util_1.error)(err, res);
