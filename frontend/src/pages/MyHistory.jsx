...
//         `api/gigs/my-gigs?page=${page}&type=${filter}&search=${debouncedSearch}`,
//         {},
//         {
...
//                         <span>Completed: {formatDate(gig.completedAt)}</span>
//                       </div>
...
//                         <span>Reward Points: {gig.rewardPoints}</span>
//                       </div>

//                       {gig.rating && (
//                         <div className="flex items-center text-yellow-500">
//                           <Star className="h-4 w-4 mr-2 fill-current" />
//                           <span>{gig.rating} / 5</span>
//                         </div>
//                       )}
//                     </div>
