  ...
  const tasks = [
    {
      ...
      longDescription:
        "This project involves creating a comprehensive task management system that allows users to create, edit, and delete tasks.",
    ...
    },
    {
      ...
      longDescription:
        "This project focuses on improving the user experience by redesigning the UI of an existing application.",
